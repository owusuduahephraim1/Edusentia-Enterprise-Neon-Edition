...
// System-wide statistic icons now preserve the certified Supabase 48px desktop / 39px mobile geometry without flex shrinking.
// Backup & Restore production deployment marker: v40 responsive release.
const CACHE = "edusentia-neon-v40";
