...
(() => {
  ...
  const tenantReady=()=>Boolean(window.EdusentiaShell?.state?.session||String((window.RCE_CONFIG||window.NIS_CONFIG||{}).tenantCode||"").trim());
