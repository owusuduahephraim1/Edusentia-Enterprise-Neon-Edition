...
export default { async fetch(request:Request,env:Env):Promise<Response>{
  ...
  try{return withHeaders(await route(request,env,requestId),request,env);}catch(e:any){
    ...
    const sqlStatus:Record<string,number>={"22023":422,"22001":422,"23514":422,"23505":409,"23503":409,"40001":409,"42501":403,"P0001":422,"P0002":404};
    const status=Number(e?.status||sqlStatus[sqlState]||500);
    const mappedCode=sqlState==="42501"?"forbidden":sqlState==="40001"?"conflict":sqlState==="P0002"?"not_found":"validation_error";
