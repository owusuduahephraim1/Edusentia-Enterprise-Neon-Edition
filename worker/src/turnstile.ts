...
export async function verifyTurnstile(env: Env, token: string, request: Request): Promise<void> {
  ...
  if (!result.success || result.hostname !== expectedHostname || result.action !== "login") {
