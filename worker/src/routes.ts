...
// Protected uploads use tenant-scoped R2 keys; teacher photographs preserve the certified teacher-relative path contract and session-scoped authorization.
