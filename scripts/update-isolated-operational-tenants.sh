...
SQL
  ...
  migration_count="$(psql "$TENANT_DATABASE_URL" -Atc "
    ...
    where version in(
      ...
      '0049u_student_portal_report_attendance_fix','0049v_live_plan_feature_parity','0049w_school_identity_logo_parity','0049x_class_scoped_student_admission_numbers','0049y_audit_permanent_reset','0049z_operational_runtime_grants'
    )
  ")"
  test "$migration_count" = "26"
