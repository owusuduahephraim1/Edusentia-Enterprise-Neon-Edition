...
test("existing isolated tenants are upgraded additively before production deployment",()=>{
  ...
  assert.match(u,/0052_school_logo_tenant_context_fix/);
  assert.match(u,/0053_blueprint_template_path_parity/);
  assert.match(u,/0054_shs_operational_parity/);
  assert.match(u,/0055_teacher_photo_r2_authorization/);
  assert.match(u,/0056_teacher_photo_neon_context_fix/);
  assert.match(u,/0057_teacher_photo_reference_contract/);
  assert.match(u,/0058_reusable_student_admission_numbers/);
  ...
  assert.match(u,/0069_backup_schedule_restore_experience/);
  assert.match(u,/test "\$migration_count" = "48"/);
