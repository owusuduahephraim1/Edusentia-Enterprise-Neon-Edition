...
reconcile_once_recorded "0057_teacher_photo_reference_contract" "$DIR/0057_teacher_photo_reference_contract.sql"
reconcile_once_recorded "0058_reusable_student_admission_numbers" "$DIR/0058_reusable_student_admission_numbers.sql"
reconcile_once_recorded "0059_student_photo_r2_contract" "$DIR/0059_student_photo_r2_contract.sql"
reconcile_once_recorded "0060_principal_photo_r2_contract" "$DIR/0060_principal_photo_r2_contract.sql"
...
reconcile_once_recorded "0065_identity_membership_upsert_fix" "$DIR/0065_identity_membership_upsert_fix.sql"
reconcile_once_recorded "0066_generated_user_email_first_name_fix" "$DIR/0066_generated_user_email_first_name_fix.sql"
...
reconcile_once_recorded "0071_backup_r2_tenant_upsert_fix" "$DIR/0071_backup_r2_tenant_upsert_fix.sql"
