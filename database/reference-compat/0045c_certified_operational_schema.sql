...
-- Source metadata: read-only Nipe certified tenant.
-- Scope: operational tables/sequences required by certified RPCs but absent from the Neon 0045b tenant template.
-- Legacy duplicate licence-state tables are intentionally excluded; licence RPCs are adapted to app/platform Neon-native state.
