...
drop trigger if exists accounts_office_staff_broadcast on public.accounts_office_staff;
CREATE TRIGGER accounts_office_staff_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.accounts_office_staff FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
drop trigger if exists accounts_office_staff_hr_sync on public.accounts_office_staff;
CREATE TRIGGER accounts_office_staff_hr_sync AFTER INSERT OR DELETE OR UPDATE ON public.accounts_office_staff FOR EACH ROW EXECUTE FUNCTION hr_sync_staff_from_source();
...
drop trigger if exists finance_fee_accounts_broadcast on public.finance_fee_accounts;
CREATE TRIGGER finance_fee_accounts_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_fee_accounts FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_fee_allocations_broadcast on public.finance_fee_allocations;
CREATE TRIGGER finance_fee_allocations_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_fee_allocations FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_fee_invoices_broadcast on public.finance_fee_invoices;
CREATE TRIGGER finance_fee_invoices_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_fee_invoices FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_fee_schedules_broadcast on public.finance_fee_schedules;
CREATE TRIGGER finance_fee_schedules_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_fee_schedules FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_fee_transactions_broadcast on public.finance_fee_transactions;
CREATE TRIGGER finance_fee_transactions_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_fee_transactions FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_payroll_item_lines_broadcast on public.finance_payroll_item_lines;
CREATE TRIGGER finance_payroll_item_lines_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_payroll_item_lines FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_payroll_items_broadcast on public.finance_payroll_items;
CREATE TRIGGER finance_payroll_items_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_payroll_items FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_payroll_profiles_broadcast on public.finance_payroll_profiles;
CREATE TRIGGER finance_payroll_profiles_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_payroll_profiles FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
drop trigger if exists finance_payroll_profiles_hr_link on public.finance_payroll_profiles;
CREATE TRIGGER finance_payroll_profiles_hr_link BEFORE INSERT OR UPDATE OF teacher_id ON public.finance_payroll_profiles FOR EACH ROW EXECUTE FUNCTION finance_sync_hr_staff_link();
...
drop trigger if exists finance_payroll_rules_broadcast on public.finance_payroll_rules;
CREATE TRIGGER finance_payroll_rules_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_payroll_rules FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_payroll_runs_broadcast on public.finance_payroll_runs;
CREATE TRIGGER finance_payroll_runs_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_payroll_runs FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_salary_grades_broadcast on public.finance_salary_grades;
CREATE TRIGGER finance_salary_grades_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_salary_grades FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
...
drop trigger if exists finance_teacher_loans_broadcast on public.finance_teacher_loans;
CREATE TRIGGER finance_teacher_loans_broadcast AFTER INSERT OR DELETE OR UPDATE ON public.finance_teacher_loans FOR EACH ROW EXECUTE FUNCTION broadcast_application_change();
