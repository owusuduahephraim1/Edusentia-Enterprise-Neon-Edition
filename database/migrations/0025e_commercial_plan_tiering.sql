...
-- Commercial tiering v2 for the independent Neon Edition.
-- This intentionally preserves the certified 27-feature catalogue while creating
-- clearer upgrade value between Starter, Professional, and Enterprise.
-- The working reference implementation remains untouched.
...
values ('0025e_commercial_plan_tiering')
on conflict do nothing;

-- Suffix migrations stay on the certified 0025 production preflight line.
